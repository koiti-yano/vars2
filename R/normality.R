...
#'
#' @aliases normality.test normality-deprecated
...
#' @note This function was named \code{normality} in earlier versions of
#' package \pkg{vars}; it is now deprecated. See \code{\link{vars-deprecated}}
#' too.
