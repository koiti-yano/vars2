...
#'
#'
#' @param x An object of class \sQuote{\code{varprd}}; generated by
#' \command{predict()}.
#' @param colors Character vector of colors to be used for shading. If unset, a
#' gray color scheme is used.
#' @param cis A numeric vector of confidence intervals. If unset the sequence
#' from 0.1 to 0.9 is used (step size 0.1).
#' @param names Character vector, names of variables for fancharts. If unset,
#' all variables are plotted.
#' @param main Character vector, title for fanchart plots.
#' @param ylab Character, ylab for fanchart.
#' @param xlab Character, xlab for fanchart.
#' @param col.y Character, color for plotted time series.
#' @param plot.type Character, if multiple all fancharts appear in one device.
#' @param nc Integer, number of columns if plot.type is multiple.
#' @param mar Vector, setting of margins.
#' @param oma Vector, setting of outer margins.
#' @param ... Dot argument, passed to plot.ts.
#' @author Bernhard Pfaff
#' @seealso \code{\link{VAR}}, \code{\link{predict}}, \code{\link{plot}},
#' \code{\link{par}}
#' @references Britton, E., P.G. Fisher and J.D. Whitley (1998), Inflation
#' Report projections: understanding the fan chart, \emph{Bank of England
