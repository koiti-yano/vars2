...
plot(var_p2_irf)
vars_plot(var_p2_irf, var_name=c("Emp", "Prod", "Real Wage", "Unemp"))
...
svar_p2_a1_irf <- irf(svar_p2_a, impulse = "e",
                     response = c("e", "prod", "rw", "U"), boot = TRUE)
plot(svar_p2_a1_irf)
vars_plot(svar_p2_a1_irf, var_name=c("Emp", "Prod", "Real Wage", "Unemp"))

# 
svar_p2_a2_irf <- irf(svar_p2_a, boot = TRUE)
#plot(svar_p2_a2_irf)
vars_plot(svar_p2_a2_irf, var_name=c("Emp", "Prod", "Real Wage", "Unemp"), 
       dev_new=TRUE)
